...
public final class SalonDtos {
 ...
 public record DirectoryResponse(Long id,String name,String description,String address,String contact,String ownerName,Double latitude,Double longitude,Double distanceKm){ static DirectoryResponse from(Salon salon,Double distanceKm){return new DirectoryResponse(salon.getId(),salon.getName(),salon.getDescription(),salon.getAddress(),salon.getContact(),salon.getOwner().getDisplayName(),salon.getLatitude(),salon.getLongitude(),distanceKm);} }
}
